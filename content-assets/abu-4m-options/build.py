...
if BRISTOL:
    optpage("05","The Bristol","Ramhan Island · Abu Dhabi · Eagle Hills","<small>from</small>Đ3.1<span>M</span>","Hotel-branded apartments · 3-beds listed on sale, 1- and 2-beds to follow · full sheet not yet public",
     ...
     [("The project","Eagle Hills' branded hotel-and-residence tower, the hospitality centrepiece of the Ramhan masterplan - beside marina residences, wellness and a retail promenade. Glazed facades, wide terraces, sea views from every unit."),
      ("The units","1-, 2- and 3-bed apartments as listed; 3-beds on sale now, 1- and 2-beds to follow. From Đ3.1M per Eagle Hills; sizes and the full price sheet not yet published."),
     ...
     fn([("From-price Đ3.1M: Eagle Hills via Calum, 23 Sep 26. Units, listed plan, timeline: Property Finder project page (developer-fed), Sep 26 - the same page says the official plan is unreleased; island villa plan: ramhan.ae, Apr 26",2),("Project, services, 2027 hotel opening: Top Luxury Property, Grand Reve, Top Ultra Luxury launch coverage, Mar-Sep 26. Brand addresses: the-bristol.com, Sep 26",1)]))
    whypage("05 · The Bristol · why here","A natural island with supply capped by its own shoreline, a 170-berth marina and a Ritz-Carlton Reserve - at Abu Dhabi's 2% entry.",
     [("1,800","Villas and ~900 marina residences on ~400 hectares",""),("Đ3.1<span>M</span>","The Bristol from · villas from ~Đ6.9M",""),("10<span> min</span>","To Yas · 15 to Saadiyat and the airport","")],
     [("The island","Naturally formed, between Saadiyat and Yas - bays, waterways, mangroves, private beaches. ~4 million sqm: 1,800 standalone villas, ~900 marina residences, a 170-berth marina, a 1.7 km retail promenade and a Ritz-Carlton Reserve cluster of floating villas. Early phases hand over from Q4 2026."),
      ...
      ("The price ladder","Villas from ~Đ6.9M (3-bed), Đ9.2M (4-bed), Đ14M (5-bed), Đ16M (6-bed), Đ22M (7-bed). Phase 4 hands over Q3 2028; Phase 5 from Đ11M, Q2 2027. The Bristol's apartments start at Đ3.1M - the Đ4M route onto the island."),
    ...
    paypage("05 · The Bristol · what you pay, when","From Đ3.1M, on the plan the sheet confirms.",
     [("~Đ62<span>K</span>","Registration 2% on the Đ3.1M entry","Fixed."),("10<span>%</span>","On booking, both plan shapes","Island villas: 10 / 40 / 50. The Bristol as listed: 10 / 60 / 30."),("Dec 2028","Completion, as listed","Hotel opening quoted 2027 by one broker.")],
     tbl(["Milestone","Share","Đ at 3.1M · 10/40/50","Đ at 3.1M · 10/60/30"],[("Booking","10%","Đ310,000","Đ310,000"),("Registration 2%","fee","Đ62,000","Đ62,000"),("Construction instalments (milestones TBC)","40% / 60%","Đ1,240,000","Đ1,860,000"),("Handover (date per the sheet)","50% / 30%","Đ1,550,000","Đ930,000"),("Cash to handover (paid-in + fee)","","~Đ1,612,000 · 52%","~Đ2,232,000 · 72%")],hl=4),
     ["<b>Income.</b> Hotel-managed short-let on a private-beach island; Abu Dhabi waterfront luxury runs 5-6% gross on comparable stock (developer-site claim). Short-let sits outside the 0% long-let cap. Hold until the rental programme is published.","<b>Decide the trigger now.</b> &ldquo;If 2-beds open at or below Đ[X], I&rsquo;m in.&rdquo; Island launches allocate on the day.","<b>Exit.</b> Pre-handover resale per Eagle Hills' paid threshold and NOC; or hold as a managed asset.","<b>The honest line.</b> A branded apartment, not a townhouse; boat access until the bridge opens; one from-price, not a sheet. This page updates the day it exists."],
     fn([("From-price: Eagle Hills via Calum, 23 Sep 26. Listed plan: Property Finder project page, Sep 26 (official plan unreleased). Island villa plan: ramhan.ae, Apr 26",2),("Registration: Abu Dhabi conventions",3)]))
...
sb=[("Price","Đ3.9M","~Đ2.3M","~Đ3.3M","~Đ3.6-4.1M","~Đ4M or less","from Đ3.1M"),
    ...
    ("Cash to handover","~Đ1.64M · 42%","~Đ1.31M · 57%","~Đ1.88M · 57%","~Đ2.81M · 74%","At launch","~Đ1.61-2.23M · plan TBC"),
