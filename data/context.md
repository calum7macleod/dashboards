...
## Open threads / flags
- P141 Malta (Constantine x Mohamed): wobbled 13 Jul, no status since 14 Jul - STALE. Ask ONCE for closure (recovered or dead + loss-log line), then archive the thread either way.
