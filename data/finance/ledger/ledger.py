...
def guess_type(r):
    ...
    if CARD_ACCOUNT_RX.search(r["account"]):
        ...
        if a < 0 and re.search(r"payment revers|unpaid direct debit|returned direct debit|unpaid dd", d, re.I): return "transfer"   # the bounced leg, pairs with the bank's RETURNED DD
