...
## Piece log
- 23 Sep: Year One milestone carousel (3 x 1080x1350, Calum's Milestone IG format: name/handle + ◆ rule, gold pill, serif title, gold number, spaced caps; photos full-bleed) - content-assets/year-one/. Format now templated in milestone.html/build.py - reuse for every milestone post (Designer Sept 26).
