...
## Queue
LOCKED 23 Sep: design-system/templates/offer-letter.html + .md = every offer to a seller. Fields only - no redesign, no new fonts, no layout changes. Agency 2% flat on the letter (VAT not itemised), conveyancing 9,950 under Đ10M, A4 PDF + 2x PNG, path content-assets/offers/<Owner>-<Unit>-Offer-<Price>M. Same rule for any future template in design-system/templates/.
