...
- Mashreq DONE 26 Sep: 189 rows, ties to the penny, closing D134.50. Commission in D784K (8 WPS credits). Out: ADIB card D279K (51), Tal D363K, QuickRemit to BoS D147K (paired to NIUM), property D458K (Verde 231K, Clear Vision 51K, Tara 125K, Modon 50K) + D288.5K of cheques 24 Apr to unknown payees, Lewis Page D45K, editors D29K, cash D21K. In from people: Tal D318K, Lewis Page D250K, Ms Abby McPhillips D119K, Eue Joshua + Pamela Urquhart D72K = co-investor pooling (Feb + Apr property events). Wise->Mashreq 5 pairs (the "Calum Lachlan" sends = Mashreq, not Nationwide).
- Waiting: ADIB CC + ADIB current (the burn), Amex x3, Nationwide?, Binance, Tal Card; answers to the question list (26 Sep chat).
