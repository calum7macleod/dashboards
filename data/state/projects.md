# PROJECTS STATE - start pack. Updated 2026-09-23 by Max (old account, first fill).

## Index (data/projects/) - last verified / confidence
- modon-wadeem-gardens.md - 22 Sep 2026 / HIGH - the live launch; both plans verified from developer graphics; worked examples for Jake (6-bed) and Ankur (4-bed) in content-assets/wadeem/
- modon-tara-park.md - Sep 2026 / MED - Calum owns; A5-108 and A2-209 trades; current phase list needed
- modon-bashayer.md - Aug 2026 / HIGH on schedule, MED on prices - Tony 8M, B4-412 pack
- modon-hudayriyat-golf-estates.md - Jul 2026 / MED - two townhouses sold; refresh phase
- hudayriyat-island.md - Sep 2026 / MED - district context, market numbers, Marsa guide to index
- aldar-yas-point.md - Aug 2026 / HIGH on Phase 1 - Tyron pack
- aldar-other.md - LOW-MED - The Wilds (verdict owed to Michael), Athlon, Terra
...
2. Modon NOC / assignment fee on pre-handover resale (Wadeem exits depend on it).
3. HGE current phase, prices, service charge.
4. Marsa guide v2 - index its contents into hudayriyat-island.md.
5. Aldar The Wilds - facts + the unsold-units answer.
6. Service charges by project (Đ/sqft/yr) - none on file.
7. Modon pipeline: what launches next and when (Market + Jake).
