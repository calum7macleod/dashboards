...
- modon-bashayer.md - Aug 2026 / HIGH on B4 Phase 2 schedule + Tony 8M; LOW-MED on launch prices (three conflicting sources); B5 floor-plate facts from the Jul 2026 launch deck
- modon-hudayriyat-golf-estates.md - Jun-Jul 2026 / MED - TH-68 Đ4.271M (Ankur) is the only register price; "two townhouses ~2-2.5M" CONFLICT flagged
- hudayriyat-island.md - Sep 2026 / MED - island stats as briefed by Modon; Marsa misattribution CORRECTED (it is Saadiyat/Aldar)
- aldar-yas-point.md - Aug 2026 / HIGH on Phase 1 (The Canopies, launched 29 Jul 2026, sold out, 1.5bn launch week)
- aldar-marsa-al-saadiyat.md - NEW · Aug 2026 / HIGH on unveiling facts, LOW on prices (Calum's estimates only)
- aldar-other.md - LOW-MED - The Wilds (verdict owed), Athlon, Terra Golf; Terra Gardens developer CONFLICT (Expo Living per Amer plan)
- abu-dhabi-other.md - NEW · LOW - Sobha City AD (moved from Dubai file), Lulu Island watch, Eagle Hills Bvlgari, Imkan Artery, Taraf
- damac-lagoons.md - 23 Sep 2026 / HIGH - register medians by cluster (Jan-22 Sep 2026, sales-only), content cases, deals/asks/offers, M-row cluster CONFLICT
...
## Conflicts flagged this pass (not resolved)
1. Wadeem cash plan: 40/60 (briefing v3/v4, context 14-15 Sep) vs 45/55 (developer graphic 22 Sep).
2. Wadeem handover month: "~month 48" (14 Sep slide) vs Jun 2031 = month 56 (22 Sep graphic).
3. Bashayer Jul 2026 launch: prices (Calum's 8.7-10M PH / 6.2-6.5M corner / 5.8-6.1M 3-bed vs competitor 2.5/3.15/4.6/6.2M) and plan (40/60 vs 50/50), handover (Dec 2029 B4 vs 2030 B5).
4. B4-412 resale price: Đ8.25M (pack) vs Đ8.0M (breakdown).
5. HGE: ledger TH-68 Đ4.271M vs file's "two townhouses ~Đ2-2.5M each".
6. Tara: two 23 Apr 2026 deals labelled "Reem Island" (A4-103, A1-1007) - Tara Park or not.
7. Lagoons M-row: Malta (offers.json, old file) vs Nice (stock.json).
8. Terra Gardens developer: Aldar (old file) vs Expo Living (Amer plan).
9. Marsa: Hudayriyat (old file) vs Saadiyat/Aldar (the guide itself) - corrected, noted.
10. Yas Point 1-bed: "around 2.5M" (Tara ad set) vs from Đ2.2M (Tyron pack).
...
## Gaps to close (ten biggest, in order)
1. Wadeem: which cash plan is on the SPA (40/60 or 45/55) and the handover month.
2. Modon NOC / assignment admin fee amount on pre-handover resale (gate is 20% + NOC; the fee decides the flip maths on Wadeem, Tara, HGE).
3. Tara Park current phase price list, unit sizes by type, handover by phase.
4. Bashayer: Tony's unit/building/SPA plan; current B5 availability and prices; is B4-412 still for sale and at what.
5. HGE: current phase, prices, sizes, handover, service charge; whether Phase 2 launched.
6. Service charges per project (only Wadeem provisional on file) - Modon, Aldar, DAMAC.
7. Aldar The Wilds: location, product, prices, plan, unsold-units answer (Michael's verdict).
8. Yas Point next phase: name, prices, dates; Phase 1 resale premiums.
